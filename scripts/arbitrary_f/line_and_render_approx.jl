...
function combined_plot_approx(;
    ...
    plt, hmap, title, cache = iron_line_profile_approx(
                                    mass = mass,
                                    spin = spin,
                                    obs_angle = obs_angle,
                                    tolerance = tolerance,
    ...
    combined_plot_approx = plot(titleplot, hmap, cbar, plt, layout=l, size=(1000,500))
end

# comb = combined_plot_approx(
#                 mass=10,
#                 spin=0.998,
#                 obs_angle=15.0,
#                 tolerance=1e-12,
